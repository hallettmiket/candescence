...
tc <-list()
tc['numba'] = "results_blue_freezie"   # this was our best one
tc['exp'] = "blue_freezie" 
...
sum_stats %>% filter(experiment=="blue_freezie", threshold==tc['opt_threshold']) %>% print(width=Inf)
sum_stats %>% filter(experiment=="slow_lax", threshold==tc['opt_threshold']) %>% print(width=Inf)
